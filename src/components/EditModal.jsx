...
export function EditModal({desDetailsData}) {
  ...
  return (
    <Modal>
      <Button className={" hover:bg-cyan-100"}
            variant="bordered"
            startContent={<Pencil width={16} />}
          > <PencilToSquare/>
            Edit
          </Button>
      <Modal.Backdrop>
        <Modal.Container placement="auto">
          <Modal.Dialog className="sm:max-w-xl">
            ...
            <Modal.Header>
              ...
              <Modal.Heading className="text-3xl text-cyan-500 font-medium">Edit Destination</Modal.Heading>
